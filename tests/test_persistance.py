...
class TestPersistance:
    ...
    def test_fixtures(self, setup_teardown, setup_x):
        print("actual test")
    ...
    def test_save_roles(serlf, setup_teardown, get_config):
        ...
        p.save_role(admin_role)
        p.save_role(user_role)
    ...
    def test_save_registration_codes(self, setup_teardown, populate_database, get_config):
        ...
        p.add_or_update_registation_code(usercode_sms)
        p.add_or_update_registation_code(usercode_mail)
